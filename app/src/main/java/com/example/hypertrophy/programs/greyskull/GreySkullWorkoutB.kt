package com.example.hypertrophy.programs.greyskull
...
@Composable
fun GreySkullWorkoutBLog(navController: NavHostController) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = "GreySkull Workout B") }
            )
        },
        bottomBar = {
            Row(
        ...
        Column(
            ...
            var exercise1 = ExerciseData(exercisename = "Bench Press", setsAndReps = exercise1SetsAndReps)
            ...
            var exercise2 = ExerciseData(exercisename = "Barbell Row", setsAndReps = exercise2SetsAndReps)
            ...
            var historyCard = HistoryCard(workoutTemplate = "GreySkull Workout B", date = todaysDate, exercises = listOfExercises)
